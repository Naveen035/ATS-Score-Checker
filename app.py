...
# Preprocessing function to clean the extracted text using NLP
...
def match_keywords(text, keywords):
    ...
    # Stem keywords for better match ("developing" -> "develop")
    ...
    # Check for partial matches using difflib
...
pdf_file = r"C:\Users\jayas\Downloads\Naveen Kumar-RESUME.pdf"  
...
def evaluate_resume(text, keywords, model, tokenizer):
    ...
    padded_sequence =   (sequence, maxlen=100)
...
# Full workflow for ATS score checker
...
ats_score_checker(pdf_file, keywords, model, tokenizer)
